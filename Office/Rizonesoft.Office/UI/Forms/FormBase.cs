...
/// <summary>
/// A base class for all forms that require localization. It subscribes to the LanguageManager.LanguageChanged event
/// and updates the form's language automatically when the event is fired.
/// </summary>
public class FormBase : XtraForm
{
    /// <summary>
    /// Initializes a new instance of the LocalizedFormBase class.
    /// </summary>
    public FormBase()
    {
        UpdateLanguage();
