...
namespace Rizone.Verbum
{
    public partial class MainForm : Form
    {
        ...
        private void initialize()
        {
            ...
            copyData.DataReceived += new Rizone.Verbum.DataReceivedEventHandler(
        ...
        private void copyData_DataReceived(object sender, Rizone.Verbum.DataReceivedEventArgs e)
        {
            if (e.Data.Equals(""))
                docIndex += 1;
