...
'			Me.richEditControl1.FinishHeaderFooterEditing += New DevExpress.XtraRichEdit.HeaderFooterEditingEventHandler(Me.richEditControl1_FinishHeaderFooterEditing);
			...
			Me.ribbonControl1.Size = New System.Drawing.Size(1019, 153)
			' 
			...
			' 
			Me.setParagraphHeadingLevelItem1.Id = 106
			...
			' 
			Me.setParagraphHeadingLevelItem2.Id = 107
			...
			' 
			Me.setParagraphHeadingLevelItem3.Id = 108
			...
			' 
			Me.setParagraphHeadingLevelItem4.Id = 109
			...
			' 
			Me.setParagraphHeadingLevelItem5.Id = 110
			...
			' 
			Me.setParagraphHeadingLevelItem6.Id = 111
			...
			' 
			Me.setParagraphHeadingLevelItem7.Id = 112
			...
			' 
			Me.setParagraphHeadingLevelItem8.Id = 113
			...
			' 
			Me.setParagraphHeadingLevelItem9.Id = 114
			...
			' 
			Me.setParagraphHeadingLevelItem10.Id = 115
			...
			' 
			Me.insertCaptionPlaceholderItem1.Id = 116
			...
			' zoomOutItem1
			' 
			Me.zoomOutItem1.Id = 137
			Me.zoomOutItem1.Name = "zoomOutItem1"
			' 
			' zoomInItem1
			' 
			Me.zoomInItem1.Id = 138
			...
			' 
			Me.closePageHeaderFooterItem1.Id = 146
			...
			Me.changeTableBorderLineStyleItem1.Id = 160
			...
			Me.changeTableBorderLineWeightItem1.Id = 161
			Me.changeTableBorderLineWeightItem1.Name = "changeTableBorderLineWeightItem1"
			' 
			' changeTableBorderColorItem1
			' 
			Me.changeTableBorderColorItem1.Id = 162
			...
			' 
			Me.selectTableElementsItem1.Id = 163
			...
			' 
			Me.deleteTableElementsItem1.Id = 169
			...
			' 
			Me.toggleTableAutoFitItem1.Id = 181
			...
			' 
			Me.toggleTableCellsTopLeftAlignmentItem1.Id = 185
			...
			' 
			Me.toggleTableCellsMiddleLeftAlignmentItem1.Id = 186
			...
			' 
			Me.toggleTableCellsBottomLeftAlignmentItem1.Id = 187
			...
			' 
			Me.toggleTableCellsTopCenterAlignmentItem1.Id = 188
			...
			' 
			Me.toggleTableCellsMiddleCenterAlignmentItem1.Id = 189
			...
			Me.changeFloatingObjectOutlineWeightItem1.Id = 197
			...
			' 
			Me.changeFloatingObjectTextWrapTypeItem1.Id = 198
			...
			' 
			Me.setFloatingObjectSquareTextWrapTypeItem1.Id = 199
			...
			' 
			Me.setFloatingObjectTightTextWrapTypeItem1.Id = 200
			...
			' 
			Me.setFloatingObjectThroughTextWrapTypeItem1.Id = 201
			...
			' 
			Me.setFloatingObjectTopAndBottomTextWrapTypeItem1.Id = 202
			...
			' 
			Me.setFloatingObjectBehindTextWrapTypeItem1.Id = 203
			...
			' 
			Me.setFloatingObjectInFrontOfTextWrapTypeItem1.Id = 204
			...
			' 
			Me.changeFloatingObjectAlignmentItem1.Id = 205
			...
			' 
			Me.setFloatingObjectTopLeftAlignmentItem1.Id = 206
			...
			' 
			Me.setFloatingObjectTopCenterAlignmentItem1.Id = 207
			...
			' 
			Me.setFloatingObjectTopRightAlignmentItem1.Id = 208
			...
			' 
			Me.setFloatingObjectMiddleLeftAlignmentItem1.Id = 209
			...
			' 
			Me.setFloatingObjectMiddleCenterAlignmentItem1.Id = 210
			...
			' 
			Me.setFloatingObjectMiddleRightAlignmentItem1.Id = 211
			...
			' 
			Me.setFloatingObjectBottomLeftAlignmentItem1.Id = 212
			...
			' 
			Me.setFloatingObjectBottomCenterAlignmentItem1.Id = 213
			...
			' 
			Me.setFloatingObjectBottomRightAlignmentItem1.Id = 214
			...
			' 
			Me.floatingObjectBringForwardSubItem1.Id = 215
